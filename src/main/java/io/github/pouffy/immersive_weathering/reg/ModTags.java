...
public class ModTags {
    ...
    public static final TagKey<Block> SILT_REPLACEABLE = registerBlockTag("silt_replaceable");
    public static final TagKey<Block> PERMAFROST_REPLACEABLE = registerBlockTag("permafrost_replaceable");
